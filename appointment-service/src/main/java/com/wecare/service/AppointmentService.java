...
//	}
	...
	public void updateAppointment(AppoitmentRequest request) {
		List<Appointment> appt = repo.findByUserId(request.getUserId());
		Appointment app = new Appointment();
		
		Iterator itr = appt.iterator();
		
		while(itr.hasNext()) {
			app = (Appointment)itr.next();
		}
